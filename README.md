...
[![CI](https://img.shields.io/github/actions/workflow/status/caasidev/laravel-gallery/ci.yml?branch=main&style=flat-square)](https://github.com/caasidev/laravel-gallery/actions/workflows/ci.yml)
